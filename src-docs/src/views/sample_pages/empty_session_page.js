...
const CHIP_DATA = {
  activity: [
    {
      key: 'insight-1',
      title: 'Search Quality Report',
      subtitle: 'Generated by AI · 10 min ago',
      summary: 'Average relevance score 0.87 across top 50 queries. 3 queries returning zero results could benefit from synonym expansion.',
      meta: 'Index: product-search',
      icon: 'search',
  ...
  recent: [
    ...
    { key: 'query-2', title: 'bluetooth speaker waterproof', subtitle: 'Search query · 18 results · 12 min ago' },
    { key: 'query-3', title: 'usb-c adapter', subtitle: 'Search query · 7 results · 30 min ago' },
  ...
  favorite: [
    ...
    { key: 'fav-2', title: 'Zero-result queries', subtitle: 'Saved query', pageKey: 'logs', typeIcon: 'navDiscover' },
  ],
  discover: [
    { key: 'log-1', title: 'Zero-result queries', subtitle: 'source=search_logs | where hits=0' },
    { key: 'log-2', title: 'Slow queries (>200ms)', subtitle: 'source=search_logs | where latency > 200' },
    { key: 'log-3', title: 'Top queries by volume', subtitle: 'source=search_logs | stats count() by query' },
    { key: 'log-4', title: 'Queries with low relevance', subtitle: 'source=search_logs | where max_score < 0.5' },
    { key: 'log-5b', title: 'Failed ingestion events', subtitle: 'source=ingest_logs | where status="ERROR"' },
  ],
  monitor: [
    { key: 'alert-1', title: 'Index health degraded', subtitle: 'Warning · 10 min ago' },
    { key: 'alert-2', title: 'Ingestion rate drop', subtitle: 'Warning · 1 hour ago' },
    { key: 'alert-3', title: 'Query latency spike', subtitle: 'Critical · 3 hours ago' },
    { key: 'alert-4', title: 'Zero-result rate above 15%', subtitle: 'Warning · 30 min ago', meta: 'Active', icon: 'alert' },
  ],
  more: [
          ...
          <div className="emptySessionPage__leftCol">
            ...
            <div className="emptySessionPage__briefing">
              ...
              <OuiText size="s">
                ...
                <p>I ran a search quality analysis on your top 50 queries. Average relevance score is <strong>0.87</strong>, but 3 queries are returning zero results that could be fixed with synonym expansion.</p>
              </OuiText>
            ...
            <div className={`emptySessionPage__rightGrid${hoveredCard ? ` emptySessionPage__rightGrid--highlight-${hoveredCard}` : ''}`}>
              ...
              <div className="emptySessionPage__favoritePanel" data-card="services">
                ...
                <div className="emptySessionPage__favoritePanelTable">
                  ...
                  <div className="emptySessionPage__favoritePanelRow">
                    <span className="emptySessionPage__favoritePanelLink--static">bluetooth speaker</span>
                  ...
                  <div className="emptySessionPage__favoritePanelRow">
                    <span className="emptySessionPage__favoritePanelLink--static">usb-c adapter</span>
              ...
              {/* Card 2: Search latency (line chart) */}
              <div className="emptySessionPage__favoritePanel">
                <div className="emptySessionPage__favoritePanelTitle">Search latency (p50 / p95)</div>
                <div style={{ height: 120 }}>
                  <Chart>
                    <Settings showLegend={false} />
                    <Axis id="bottom" position="bottom" tickFormat={(d) => `${d}m`} />
                    <Axis id="left" position="left" tickFormat={(d) => `${d}ms`} />
                    <LineSeries
                      id="p50"
              ...
              <div className="emptySessionPage__favoritePanel">
                <div className="emptySessionPage__favoritePanelTitle">Relevance score distribution</div>
                <div style={{ height: 120 }}>
                  <Chart>
                    <Settings showLegend={false} />
